<%@ Page Title="" Language="C#" MasterPageFile="~/WMSMain.master" AutoEventWireup="true"
    CodeFile="ItemKit.aspx.cs" Inherits="ItemKit" %>
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="span12">
                ...
                <h3 class="page-title">
                    Material Kit <small>Create & Manage Material Kit Details... </small>
                </h3>
                <ul class="breadcrumb">
                    <li><a href="#"><i class="icon-home"></i></a><span class="divider">&nbsp;</span>
                    </li>
                    <li><a href="#">Material Manager</a> <span class="divider">&nbsp;</span> </li>
                    <li><a href="ItemKit.aspx">Material Kit</a><span class="divider-last">&nbsp;</span></li>
                </ul>
            ...
            <div class="span12">
                <div class="widget">
                    <div class="widget-title">
                        <h4>
                            <i class="icon-globe"></i>Material Kits</h4>
                        <span class="tools"><a href="javascript:;" class="icon-chevron-down"></a></span>
                    </div>
                    <div class="widget-body">
                        <asp:MultiView ID="MVMatrialKit" runat="server" ActiveViewIndex="0">
                            <asp:View ID="View0" runat="server">
                                ...
                                <div class="row-fluid">
                                    <div class="span12" style="overflow-x: auto;">
                                        <asp:GridView ID="GVKitMaterial" runat="server" CssClass="table table-advance table-bordered table-condensed table-hover"
                                            ...
                                            PageSize="10" OnPageIndexChanging="GVKitMaterial_PageIndexChanging" OnRowCommand="GVKitMaterial_RowCommand">
                                            <Columns>
                            ...
                            <asp:View ID="View1" runat="server">
                                    ...
                                    <div class="span12">
                                        ...
                                        <div class="span6">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <asp:DropDownList ID="DDLItemList" runat="server" AutoPostBack="true" 
                                                     OnSelectedIndexChanged="ItemList_SelectedIndexChanged"></asp:DropDownList>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="span6">
                                ...
                                <div class="row-fluid">
                                    <div class="span12" style="overflow-x: auto;">
                                        <asp:GridView ID="GVInner" runat="server" CssClass="table table-hover table-advance" Width="100%" 
                                            AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" HeaderStyle-Wrap="false" 
